...
//		System.out.println(new String(b,"utf-8"));
        ...
        str = "a:7:{s:9:\"_previous\";a:1:\n" +
                "{s:3:\"url\";s:50:\"http://mch.wxrrd.com/open/userinfo.json\";}s:5:\"flash\n" +
        ...
        try {
			Map<String, Object> map2 =(Map<String, Object>)PHPSerializer.unserialize(str.replaceAll("\n","").getBytes());
